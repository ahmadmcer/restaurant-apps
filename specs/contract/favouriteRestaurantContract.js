...
const itsActsAsFavouriteRestaurantModel = (favouriteRestaurant) => {
  it('should return the restaurant that has been added', async () => {
    favouriteRestaurant.putRestaurant({ id: 1 });
    favouriteRestaurant.putRestaurant({ id: 2 });

    expect(await favouriteRestaurant.getRestaurant(1))
      .toEqual({ id: 1 });
    expect(await favouriteRestaurant.getRestaurant(2))
      .toEqual({ id: 2 });
    expect(await favouriteRestaurant.getRestaurant(3))
      .toEqual(undefined);
  });
  ...
  it('should refuse a restaurant from being added if it does not have the correct property', async () => {
    ...
    expect(await favouriteRestaurant.getAllRestaurants())
      .toEqual([]);
  });
...
export { itsActsAsFavouriteRestaurantModel };
